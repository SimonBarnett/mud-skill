...
4. LOCKED — If that MUD's terms forbid robot scripts or triggers (Discworld does; see `discworld-character-creation`), stop on the terms screen. Do not accept them from an unattended agent.
